            ...
            $data = [
                ...
                'data' => [
                    ...
                    'config' => [
                        ...
                        'gst_rate' => isset($order->tax_rate) && $order->tax_rate > 0 ? (float)$order->tax_rate : floatval(readConfig('tax_gst_rate') ?: 17),
                        'gst_enabled' => (isset($order->tax_amount) && $order->tax_amount > 0) || readConfig('tax_gst_enabled') == 1,

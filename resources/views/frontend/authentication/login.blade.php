...
<body>
    ...
    <style>
        /* Fix login screen to fit viewport without scroll */
        ...
        .authentications .left-content { display: none; }
        @media (min-width: 992px) {
            .authentications .left-content { display: flex; }
        }
        ...
        .authentication-form { gap: 1.5rem !important; }
        .authentication-form-content .row { --bs-gutter-y: 0.75rem; }
    </style>
            ...
            <form action="{{ route('login') }}" method="post" class="authentication-form px-lg-5 needs-validation"
                ...
                <div class="authentication-form-header">
                    <a href="{{ route('frontend.home') }}" class="logo">
                        <img src="{{ asset('assets/images/branding/sinyx-full.png') }}" width="250px" alt="SINYX Logo">
                    </a>

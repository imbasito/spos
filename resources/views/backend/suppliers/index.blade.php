        ...
        <div class="row mb-4">
          <div class="col-md-12">
            <div class="input-group shadow-sm spotlight-search-group">
              ...
              <input type="text" id="quickSearchInput" class="form-control border-0 py-4 apple-input" placeholder="Search supplier name, phone, or address..." autofocus style="font-size: 1rem; box-shadow: none;">
            </div>
          </div>
        </div>

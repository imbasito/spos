    ...
    <div class="card shadow-sm border-0 border-radius-15 overflow-hidden" style="min-height: 70vh;">
      <div class="card-header bg-white py-3 d-flex align-items-center border-bottom-0">
        <h3 class="card-title font-weight-bold text-dark mb-0">
          <i class="fas fa-truck-moving mr-2 text-primary"></i> Supplier Directory
        </h3>
        @can('supplier_create')
        <a href="{{ route('backend.admin.suppliers.create') }}" class="btn bg-gradient-primary btn-md px-4 ml-auto shadow-sm hover-lift font-weight-bold text-white" style="color: #fff !important;">
          <i class="fas fa-plus-circle mr-1 text-white" style="color: #fff !important;"></i> Add New Supplier
        </a>
        @endcan
      </div>

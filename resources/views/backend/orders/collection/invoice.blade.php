      ...
      <div class="row mb-4">
        <div class="col-4">
          <h2 class="page-header">
            <img src="{{ assetImage(readconfig('site_logo')) }}" height="80" width="120" alt="Logo"
              class="brand-image elevation-3" style="opacity: .9; object-fit: contain; border-radius: 8px;"> {{ readConfig('site_name') }}
          </h2>
        </div>
        <div class="col-4">

...
<script type="text/javascript">
  ...
  window.finalizeRefundReceiptLoad = function() {
      console.log("[Refund] Finalizing load...");
  ...
  window.openRefundReceiptV3 = function(url) {
      ...
      console.log("[Refund] Opening Receipt:", url);
      ...
      setTimeout(() => {
          console.log("[Refund] Safety timeout fired");
          window.finalizeRefundReceiptLoad();
      }, 2000);

      const cacheBuster = url.indexOf('?') !== -1 ? '&_v=' : '?_v=';
      if(frame) {
          // Native OnLoad Event (Most Reliable)
          frame.onload = function() {
              console.log("[Refund] Frame Native Load Event Fired");
              window.finalizeRefundReceiptLoad();
          };
...
<div class="modal fade" id="refundReceiptModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 420px;">
        <div class="modal-content shadow-lg" style="border: none; border-radius: 8px;">
            ...
            <!-- Modal Body (Iframe) -->
            <div class="modal-body p-0 position-relative" style="height: 600px; background: var(--system-gray-6);">
                <!-- Loader -->
                <!-- Loader Removed for Stability -->

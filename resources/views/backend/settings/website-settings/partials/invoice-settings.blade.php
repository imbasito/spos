<form action="{{ route('backend.admin.settings.website.invoice.update') }}" method="post" data-ajax-save>
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    <div class="form-group">
                        ...
                        <textarea class="form-control apple-input" name="note_to_customer_invoice" placeholder="Thank you for shopping with us!">{{ readConfig('note_to_customer_invoice') }}</textarea>
                    </div>
                </div>
